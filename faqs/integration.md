...
For the standard integration flow, start with [Token Integration](../docs/token-integration.md), [Messages on Arweave](../docs/messages-on-arweave.md), [Running A Node](../docs/running-a-node.md), and [Monitor Token](../docs/monitor-token.md).
